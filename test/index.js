// melakukan pengetesan web
// cara mejalankan di terminal npm test

const chai = require("chai");
const chaiHttp = require("chai-http");

// fs = file sydtem dependencies buat mengirim file/ gambar
const fs = require("fs");

// harapan hasil test
const expect = chai.expect;

// import endpoint file yg akan di test
